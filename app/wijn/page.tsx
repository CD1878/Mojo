...
export default function Wijn() {
  return (
    <div className="pt-28 bg-green text-background min-h-screen">
      <div className="max-w-5xl mx-auto px-4 pt-12 pb-24 md:py-32">
        <h1 className="text-center mb-32 tracking-wide font-display text-accent uppercase">WIJNEN</h1>
        
        <h2 className="mb-20 tracking-wide font-display text-accent text-center uppercase">WIT</h2>
        ...
        <h2 className="mb-20 tracking-wide font-display text-accent text-center uppercase">ROOD</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 mb-32">
        ...
        <h2 className="mb-20 tracking-wide font-display text-accent text-center uppercase">ROSE</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 mb-32">
        ...
        <h2 className="mb-20 tracking-wide font-display text-accent text-center uppercase">ORANJE</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 mb-32">
        ...
        <h2 className="mb-20 tracking-wide font-display text-accent text-center uppercase">BUBBELS</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 mb-32">
