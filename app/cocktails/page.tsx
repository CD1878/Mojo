  ...
  return (
    <div className="pt-28 bg-background text-dark min-h-screen">
      <div className="max-w-[1200px] mx-auto px-4 pt-4 pb-24 lg:pt-8 lg:pb-32">
        ...
        <h1 className="mb-12 lg:mb-32 tracking-wide text-accent font-display text-center uppercase">COCKTAILS</h1>
        ...
        <h2 className="mb-8 lg:mb-20 tracking-wide text-accent font-display uppercase">GIN & TONIC'S</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-12 mb-16 lg:mb-32">
        ...
        <h2 className="mb-8 lg:mb-20 tracking-wide text-accent font-display uppercase">LONGDRINKS</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-12 mb-16 lg:mb-32">
          <MenuItem title="LIMONCELLO SPRITZ" price="11,50" />
          <MenuItem title="SHOT" price="4,50" />
        </div>

        <h2 className="mb-8 lg:mb-20 tracking-wide text-accent font-display uppercase">HARD SELTZER</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-12 mb-16 lg:mb-32">
          <MenuItem title="GIG PASSIONFRUIT 5%" price="6,00" />
        </div>

        <h2 className="mb-8 lg:mb-20 tracking-wide text-accent font-display uppercase">HUISGEMAAKTE LIMONCELLO</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-12 mb-16 lg:mb-32">
